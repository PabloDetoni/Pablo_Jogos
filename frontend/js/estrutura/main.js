...
function setupAdminBtn() {
  document.getElementById('admin-actions').addEventListener('click', function(e) {
    if (e.target && e.target.id === 'btn-admin') {
      window.location.href = '/frontend/html/estrutura/admin.html';
    }
  });
}
...
function setupLogoutBtn() {
  document.getElementById('logout-btn').addEventListener('click', function() {
    ...
    localStorage.clear();
    window.location.href = '/frontend/html/estrutura/login.html'; // Redireciona para a tela de login
  });
}
...
function abrirRanking() {
  window.location.href = '/frontend/html/estrutura/rankings.html';
}
...
function setupEstatisticasBtn() {
  document.getElementById('btn-estatisticas').onclick = () => window.location.href = '/frontend/html/estrutura/estatisticas.html';
}

// Redireciona para login.html
function irParaLogin() {
  window.location.href = '/frontend/html/estrutura/login.html';
}
