...
// A inicialização é feita no topo do arquivo apenas quando os elementos existem.
// Não chamar preencherSelects() indiscriminadamente aqui para evitar erros
// quando o script é carregado em páginas que não contêm os selects de ranking.