...
async function carregarBancoPalavras() {
  try {
    // CSV estático está sob a pasta frontend; servidor também serve com prefixo /frontend
    const respostaCSV = await fetch("/frontend/Info_extra/CSV_Forca/palavras.csv");
